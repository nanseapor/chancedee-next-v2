      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6">
          ...
          <div className="flex gap-3">
            {missingSections.length > 0 && (
              <Link
                href={`/jobsmarket/candidates/${profile.uid}/profile/edit`}
                className="flex-1 px-4 py-2 bg-secondary-600 text-white text-sm font-medium rounded-lg hover:bg-secondary-700 transition-colors text-center"
              >
                แก้ไขโปรไฟล์
              </Link>
            )}
