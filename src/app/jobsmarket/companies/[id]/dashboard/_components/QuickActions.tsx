  ...
  return (
    <Card className={className}>
      ...
      <CardContent className="space-y-3">
        {/* Create Job - Primary */}
        {canPostJobs ? (
          <Link href={`/jobsmarket/companies/${companyId}/dashboard/jobs/new`} className="block">
        ...
        <Link href={`/jobsmarket/companies/${companyId}/dashboard/applications`} className="block">
