      ...
      <div className="flex flex-col md:flex-row md:items-start gap-6">
        ...
        <div className="relative group">
          ...
          <Button
            ...
            className="absolute inset-0 w-full h-full rounded-full bg-black bg-opacity-0 group-hover:bg-opacity-30 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all disabled:cursor-not-allowed hover:bg-black hover:bg-opacity-30"
          >
            {isUploadingPhoto ? (
