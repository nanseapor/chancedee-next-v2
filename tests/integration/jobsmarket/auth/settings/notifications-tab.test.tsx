...
describe("NotificationsTab Component", () => {
  ...
  describe("Email notifications section", () => {
    ...
    it("should render all 5 email notification options", () => {
      ...
      // These appear in both email and push sections, so use getAllByText
      expect(screen.getAllByText("อัปเดตใบสมัคร").length).toBeGreaterThanOrEqual(2);
      expect(screen.getAllByText("การนัดสัมภาษณ์").length).toBeGreaterThanOrEqual(2);
